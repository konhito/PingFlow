  ...
  const features = [
    {
      ...
      description:
        "Connect your SaaS app in minutes with our easy-to-use API. No complex setup required, just plug and play.",
    },
    {
      icon: <Brain className="text-primary h-6 w-6" />,
      title: "Smart Routing",
      description:
        "Intelligent notification routing ensures the right team gets the right alerts. Stay informed without the noise.",
    },
    {
      icon: <Zap className="text-primary h-6 w-6" />,
      title: "Lightning Fast",
      description:
        "Real-time event tracking with instant delivery. Never miss a critical moment in your business operations.",
    },
  ];
    ...
    <section className="relative overflow-hidden py-20 lg:py-32">
      ...
      <div className="relative z-10 container mx-auto">
        ...
        >
          ...
          >
            <span className="font-excon font-black">Monitor </span>
            ...
            <span className="font-excon font-black"> with PingFlow</span>
          </motion.h2>
          ...
          <motion.p
            ...
            variants={titleVariants}
          >
            Transform how you track events with our innovative platform
            designed for modern SaaS teams. Managing notifications is challenging
